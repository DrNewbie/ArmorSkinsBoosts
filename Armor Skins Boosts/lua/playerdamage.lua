...
function PlayerDamage:set_regenerate_timer_to_max()
	...
	if armor_skins_data and armor_skins_data.body_armor and armor_skins_data.body_armor.armor_regen and type(armor_skins_data.body_armor.armor_regen[equipped_armor]) == "number" then
		self._regenerate_timer = self._regenerate_timer * (1-(armor_skins_data.body_armor.armor_regen[equipped_armor] or 0))
	end
